<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="DecWebTestSite.WebForm1" 
Title="Login Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    Not Registered Yet? <a href="Register.aspx">Create an account!</a>
    
    <br />
    <br />
    For testing, use "Aaron" with password "1"
    <br />
    <br />
